...
(function () {
    ...
    var dlxMusicApp = function () {
        function dlxMusicApp() {
            _classCallCheck(this, dlxMusicApp);
        }

        _createClass(dlxMusicApp, [{
            key: 'beforeRegister',
...
//# sourceMappingURL=dlx-music-app.js.map
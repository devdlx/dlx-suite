    ...
    var dlxSoundcloud = function () {
        ...
        _createClass(dlxSoundcloud, [{
            ...
            value: function _computeUserFromStorage(app) {
                ...
                var _user = localStorage.getItem("dlx-soundcloud-user");
                console.log(_user);
                if (_user) {
            ...
            value: function _computeUser(user) {
                ...
                if (user) {
                    ...
                    user.getToken().then(function (accessToken) {
                        ...
                        localStorage.setItem("dlx-soundcloud-user", _user || user);
                    });
                } else {
                    this.set('user', null);
                    // User is signed out.
            ...
            value: function signOut() {
                ...
                return firebase.auth().signOut().then(function () {
                    ...
                    this.fire('dlx-soundcloud-auth-error', {
                        errorCode: errorCode,
            ...
            value: function signIn(email, password) {
                ...
                return firebase.auth().signInWithEmailAndPassword(email, password).then(function (e) {
                    ...
                    _this7.fire('dlx-soundcloud-auth-signedin', {
                        user: user
                    }, {
                        bubbles: false
                    });
                    ...
                    var errorMessage = error.message;
                    console.log(errorCode, errorMessage);
                    _this7.fire('dlx-soundcloud-auth-error', {
                        errorCode: errorCode,
                        errorMessage: errorMessage
                    }, {
                        bubbles: false
...
//# sourceMappingURL=dlx-soundcloud.js.map